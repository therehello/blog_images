...
def compress_photo():
    '''调用压缩图片的函数
    '''
    src_dir, des_dir = "/Users/therehello/my/blog_images/photos/", "/Users/therehello/my/blog_images/min_photos/"
...
def handle_photo():
    ...
    with open("/Users/therehello/Documents/blog/themes/next/source/lib/album/data.json","w") as fp:
...
def cut_photo():
    ...
    """
    src_dir = "/Users/therehello/my/blog_images/photos/"
    if directory_exists(src_dir):
        if not directory_exists(src_dir):
            make_directory(src_dir)
        # business logic
